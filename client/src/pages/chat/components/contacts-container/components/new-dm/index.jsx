        ...
        <TooltipProvider>
          ...
          <Dialog open = {openNewContactModel} onOpenChange={setOpenNewContactModel}>
              <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                      ...
                      <div className="flex flex-col gap-5">
                        {
                          searchedContacts.map((contact) => (
                            <div key={contact._id || contact.id} className="flex gap-3 items-center cursor-pointer" onClick={()=> selectNewContact(contact)}>
                  ...
                  {
                      searchedContacts.length <= 0 && <div className="flex md:flex flex-col mt-8 justify-center items-center duration-1000 transition-all"><Lottie
